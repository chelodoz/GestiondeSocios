...
@section ('contenido')
	<div class="row">
		<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
			...
			{!!Form::model($array,['method'=>'PATCH', 'route'=> ['egresos.pago_profesional.profesional', $array[0], $array[1]]])!!}
			{{Form::token()}}
	...
	<div class="row">
		...
		<div class="col-lg-4 col-sm-4 col-md-4 col-xs-10">
			<div class="form-group">
				@foreach($value as $v)
				<input type="text" name="importe_taller_personal" required value="{{$v->importe_taller_personal}}" class="form-control" readonly>
				@endforeach
			</div>
		</div>
		<div class="row">
		<div class="col-lg-4 col-sm-4 col-md-4 col-xs-10">
			<div class="form-group">
				@foreach($value as $v)
				<input type="text" name="estado_taller_personal" required value="{{$v->estado_taller_personal}}" class="form-control" readonly>
				@endforeach
			</div>
		</div>
	</div>
